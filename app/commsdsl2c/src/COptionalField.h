...
class CGenerator;
class COptionalField final : public commsdsl::gen::GenOptionalField, public CField
{
...
public:
    ...
    COptionalField(CGenerator& generator, ParseField parseObj, GenElem* parent);
...
private:
    ...
    const CField* m_cMemField = nullptr;
};
