...
class CGenerator;
class CBitfieldField final : public commsdsl::gen::GenBitfieldField, public CField
{
...
public:
    ...
    CBitfieldField(CGenerator& generator, ParseField parseObj, GenElem* parent);
