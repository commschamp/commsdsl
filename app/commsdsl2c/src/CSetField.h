...
class CGenerator;
class CSetField final : public commsdsl::gen::GenSetField, public CField
{
...
public:
    ...
    CSetField(CGenerator& generator, ParseField parseObj, GenElem* parent);
...
private:
    ...
    std::string cHeaderBitsCodeInternal() const;
    std::string cSourceBitsCodeInternal() const;
};
