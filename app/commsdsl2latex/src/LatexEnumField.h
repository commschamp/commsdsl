...
class LatexEnumField final : public commsdsl::gen::GenEnumField, public LatexField
{
...
public:
    ...
    LatexEnumField(LatexGenerator& generator, ParseField parseObj, GenElem* parent);
