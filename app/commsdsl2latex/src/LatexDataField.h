...
class LatexDataField final : public commsdsl::gen::GenDataField, public LatexField
{
...
public:
    ...
    LatexDataField(LatexGenerator& generator, ParseField parseObj, GenElem* parent);
