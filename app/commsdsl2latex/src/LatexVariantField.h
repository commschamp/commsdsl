...
class LatexVariantField final : public commsdsl::gen::GenVariantField, public LatexField
{
...
public:
    ...
    LatexVariantField(LatexGenerator& generator, ParseField parseObj, GenElem* parent);
