...
class LatexListField final : public commsdsl::gen::GenListField, public LatexField
{
...
public:
    ...
    LatexListField(LatexGenerator& generator, ParseField parseObj, GenElem* parent);
