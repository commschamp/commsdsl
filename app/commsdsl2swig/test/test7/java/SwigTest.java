public class SwigTest {
    private test7_p.message_Msg1 m_msg1 = null;

    static {
        System.loadLibrary("commsdsl2swig_test7_java");
    }

    public void setMsg1(test7_p.message_Msg1 msg) {
        m_msg1 = msg;
    }    

    public void doTest1() {
        var msg = new test7_p.message_Msg1();
        ...
        var frame = new test7_p.frame_Frame();
        ...
        assert test7_p.test7.eq_message_Msg1(msg, m_msg1): "Messages not equal";
