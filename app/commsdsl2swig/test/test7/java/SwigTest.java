public class SwigTest {
    private test7_swig.message_Msg1 m_msg1 = null;

    static {
        System.loadLibrary("test7_swig_java");
    }

    public void setMsg1(test7_swig.message_Msg1 msg) {
        m_msg1 = msg;
    }

    public void doTest1() {
        var msg = new test7_swig.message_Msg1();
        ...
        var frame = new test7_swig.frame_Frame();
        ...
        assert test7_swig.test7.eq_message_Msg1(msg, m_msg1): "Messages not equal";
