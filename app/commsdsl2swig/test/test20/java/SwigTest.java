public class SwigTest {
    private test20_p.message_Msg1 m_msg1 = null;
    private test20_p.message_Msg2 m_msg2 = null;

    static {
        System.loadLibrary("commsdsl2swig_test20_java");
    }

    public void setMsg1(test20_p.message_Msg1 msg) {
        m_msg1 = msg;
    }

    public void setMsg2(test20_p.message_Msg2 msg) {
        m_msg2 = msg;
    }    

    public void doTest1() {
        var msg = new test20_p.message_Msg2();
        ...
        var frame = new test20_p.frame_Frame();
        ...
        assert test20_p.test20.eq_message_Msg2(msg, m_msg2): "Messages not equal";
