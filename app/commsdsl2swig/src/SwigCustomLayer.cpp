...
SwigCustomLayer::SwigCustomLayer(SwigGenerator& generator, commsdsl::parse::Layer dslObj, commsdsl::gen::Elem* parent) : 
...
bool SwigCustomLayer::swigReorderImpl(SwigLayersList& siblings, bool& success) const
{
    auto obj = customDslObj();
    if (obj.semanticLayerType() != commsdsl::parse::Layer::Kind::Checksum) {
        return SwigBase::swigReorderImpl(siblings, success);
    }
