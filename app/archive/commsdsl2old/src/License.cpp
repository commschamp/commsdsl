...
bool License::writeTxt() const
{
    ...
    static const std::string Template = 
        "This code has been generated by the commsdsl2old[1] application has no license,\n"
        "the vendor is free to pick any as long as it's compatibile with the license(s) of the\n"
        "used componets provided by the cc_tools_qt[2] project.\n\n"
        ...
        "[2]: https://github.com/commschamp/cc_tools_qt\n"
        "[3]: https://github.com/commschamp/comms\n"
        "[4]: https://www.mozilla.org/en-US/MPL/2.0/\n"
        "[5]: https://github.com/commschamp/cc_tools_qt\n"
        "[6]: https://www.qt.io/\n"
