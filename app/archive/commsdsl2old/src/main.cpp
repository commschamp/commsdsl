...
{
    try {
        commsdsl2old::ProgramOptions options;
        commsdsl2old::Logger logger;
        ...
        auto files = commsdsl2old::getFilesList(options.getFilesListFile(), options.getFilesListPrefix());
        ...
        commsdsl2old::Generator generator(options, logger);
