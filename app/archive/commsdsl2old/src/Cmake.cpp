...
bool Cmake::writeMain() const
{
    ...
    static const std::string Template = 
        ...
        "# OPT_CC_TAG - Override default tag of cc_tools_qt project.\n"
        ...
        "# OPT_EXTERNALS_DIR - Directory where externals (cc_tools_qt) are checked out,\n"
        ...
        "set (CC_EXTERNAL_TGT \"cc_tools_qt_external\")\n"
        ...
        "    cc_prefetch(SRC_DIR \"${OPT_EXTERNALS_DIR}/cc_tools_qt\" TAG \"${OPT_CC_TAG}\")\n"
        "    include(${OPT_EXTERNALS_DIR}/cc_tools_qt/cmake/CC_External.cmake)\n\n"
        "    set (qt_dir_opt)\n"
        "    if (NOT \"${OPT_QT_DIR}\" STREQUAL \"\")\n"
        ...
        "        SRC_DIR ${OPT_EXTERNALS_DIR}/cc_tools_qt\n"
        "        BUILD_DIR ${PROJECT_BINARY_DIR}/cc_tools_qt\n"
        ...
        "    )\n"
        "    set (cc_compile_file \"${OPT_EXTERNALS_DIR}/cc_tools_qt/cmake/CC_Compile.cmake\")\n"
...
bool Cmake::writePlugin() const
{
    ...
    static const std::string Template =
        ...
        "    target_link_libraries (${name} PUBLIC #^#PROJ_NAMESPACE#$# cc::comms cc::cc_tools_qt Qt5::Widgets Qt5::Core)\n"
        ...
        "    target_link_libraries (${name} ${ALL_MESSAGES_LIB} cc::cc_tools_qt Qt5::Widgets Qt5::Core ${extra_link_opts})\n"
        "    target_compile_options(${name} PRIVATE\n"
        "        $<$<CXX_COMPILER_ID:MSVC>:/bigobj /wd4127 /wd5054>\n"
        "        $<$<CXX_COMPILER_ID:GNU>:-ftemplate-depth=2048>\n"
        "        $<$<CXX_COMPILER_ID:Clang>:-ftemplate-depth=2048>\n"
...
bool Cmake::writePrefetch() const
{
    ...
    static const std::string Contents = 
        "set (CC_FETCH_DEFAULT_REPO \"https://github.com/commschamp/cc_tools_qt.git\")\n"
