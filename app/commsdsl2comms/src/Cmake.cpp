...
bool Cmake::writeMain() const
{
    ...
    static const std::string Template = 
        ...
        "# OPT_TEST_OPTIONS - Class name of the options for test applications, defaults to #^#DEFAULT_OPTIONS#$#.\n"        
        "# OPT_TEST_INTERFACE - Class name of the interface for test applications, defaults to #^#DEFAULT_INTERFACE#$#.\n"
        "# OPT_TEST_FRAME - Class name of the frame for test applications, defaults to #^#DEFAULT_FRAME#$#.\n"
        "# OPT_TEST_INPUT_MESSAGES - All input messages bundle for test applications, defaults to #^#DEFAULT_INPUT#$#.\n\n"
        ...
        "if (\"${OPT_CC_MAIN_INSTALL_DIR}\" STREQUAL \"\")\n"
        "    set (cc_tag \"#^#CC_TAG#$#\")\n"
