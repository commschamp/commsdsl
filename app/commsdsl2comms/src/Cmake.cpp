...
bool Cmake::writeMain() const
{
    ...
    static const std::string Template = 
        ...
        "option (OPT_EXPORT_AS_SYSTEM_HEADERS \"Export protocol library target to be included as system headers.\" ON)\n\n"
        "# Other parameters:\n"
        ...
        "    endif ()\n\n"
        "    set (cc_export_as_system_headers_opt)\n"
        "    if (${OPT_EXPORT_AS_SYSTEM_HEADERS})\n"
        "        set (cc_export_as_system_headers_opt \"-DCC_EXPORT_AS_SYSTEM_HEADERS=ON\")\n"
        "    endif ()\n\n"        
        ...
        "        ${cc_export_as_system_headers_opt}\n"
        "        CMAKE_ARGS\n"
        ...
        "endif ()\n\n"
        "target_include_directories(#^#PROJ_NAMESPACE#$# ${sys_prefix} INTERFACE\n"
