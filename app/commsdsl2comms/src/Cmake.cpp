...
bool Cmake::writePlugin() const
{
    ...
    static const std::string Template =
        ...
        "        $<$<CXX_COMPILER_ID:GNU>:-ftemplate-backtrace-limit=0 -ftemplate-depth=2048>\n"
        "        $<$<CXX_COMPILER_ID:Clang>:-ftemplate-backtrace-limit=0 -ftemplate-depth=2048>\n"
        "    )\n\n"        
        "    install (\n"
        "        TARGETS ${name}\n"
...
bool Cmake::writeTest() const
{
    ...
    static const std::string Template =
        ...
        "        $<$<CXX_COMPILER_ID:GNU>:-Wno-unused-function -ftemplate-backtrace-limit=0 -ftemplate-depth=2048>\n"
        "        $<$<CXX_COMPILER_ID:Clang>:-Wno-unused-function -Wno-unneeded-internal-declaration -ftemplate-backtrace-limit=0 -ftemplate-depth=2048>\n"
        "    )\n"
        "endfunction ()\n\n"
        "######################################################################\n\n"
