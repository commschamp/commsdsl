...
bool License::writeTxt() const
{
    ...
    static const std::string Template = 
        ...
        "[2]: https://github.com/arobenko/comms_champion\n"
        "[3]: https://github.com/arobenko/comms_champion#comms-library\n"
        "[4]: https://www.mozilla.org/en-US/MPL/2.0/\n"
        "[5]: https://github.com/arobenko/comms_champion#commschampion-tools\n"
        "[6]: https://www.qt.io/\n"
