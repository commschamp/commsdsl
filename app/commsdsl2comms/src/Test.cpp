...
bool Test::writeInputTest() const
{
    ...
    static const std::string Template = 
        ...
        "        static_assert(!std::is_same<UnknwonFieldTag, Tag>::value, \"Field type hasn't been detected\");\n\n"
        ...
        "    struct BitfieldFieldTag {};\n"
        "    struct BundleFieldTag {};\n"
        "    struct FloatFieldTag {};\n"
        "    struct StringFieldTag {};\n"
        "    struct ArrayListFieldTag {};\n"
        "    struct OptionalFieldTag {};\n"
        "    struct VariantFieldTag {};\n"
        "    struct UnknwonFieldTag {};\n\n"
        "    template <typename TField>\n"
        "    using FieldTag = \n"
        "        typename std::conditional<\n"
        "            comms::field::isIntValue<TField>(),\n"
        "            IntFieldTag,\n"
        "            typename std::conditional<\n"
        ...
        "                    BitmaskFieldTag,\n"
        "                    typename std::conditional<\n"
        "                        comms::field::isBitfield<TField>(),\n"
        "                        BitfieldFieldTag,\n"
        "                        typename std::conditional<\n"
        "                            comms::field::isBundle<TField>(),\n"
        "                            BundleFieldTag,\n"
        "                            typename std::conditional<\n"
        "                                comms::field::isFloatValue<TField>(),\n"
        "                                FloatFieldTag,\n"
        "                                typename std::conditional<\n"
        "                                    comms::field::isString<TField>(),\n"
        "                                    StringFieldTag,\n"
        "                                    typename std::conditional<\n"
        "                                        comms::field::isArrayList<TField>(),\n"
        "                                        ArrayListFieldTag,\n"
        "                                        typename std::conditional<\n"
        "                                            comms::field::isOptional<TField>(),\n"
        "                                            OptionalFieldTag,\n"
        "                                            typename std::conditional<\n"
        "                                                comms::field::isVariant<TField>(),\n"
        "                                                VariantFieldTag,\n"
        "                                                UnknwonFieldTag\n"
        "                                            >::type\n"
        "                                        >::type\n"
        ...
        "        >::type;\n\n"
        "    template <typename TField>\n"
        "    static void printFieldValue(const TField& field, IntFieldTag)\n"
        "    {\n"
        ...
        "    }\n\n"
        "    template <typename TField>\n"
        "    void printFieldValue(const TField& field, BitfieldFieldTag) const\n"
        "    {\n"
        "        std::cout << \'\\n\';\n"
        "        comms::util::tupleForEach(field.value(), FieldPrinter(m_indent + 1));\n"
        "    }\n\n"
        "    template <typename TField>\n"
        "    void printFieldValue(const TField& field, BundleFieldTag) const\n"
        "    {\n"
        "        std::cout << \'\\n\';\n"
        "        comms::util::tupleForEach(field.value(), FieldPrinter(m_indent + 1));\n"
        "    }\n\n"
        "    template <typename TField>\n"
        "    static void printFieldValue(const TField& field, FloatFieldTag)\n"
        "    {\n"
        "        std::cout << field.value();\n"
        "    }\n\n"
        "    template <typename TField>\n"
        "    static void printFieldValue(const TField& field, StringFieldTag)\n"
        "    {\n"
        "        std::cout << field.value().c_str();\n"
        "    }\n\n"
        "    template <typename TField>\n"
        "    void printFieldValue(const TField& field, ArrayListFieldTag) const\n"
        "    {\n"
        "        using Tag = \n"
        "            typename std::conditional<\n"
        "                std::is_integral<typename TField::ElementType>::value,\n"
        "                IntElementTag,\n"
        "                FieldElementTag\n"
        "            >::type;\n\n"
        ...
        "    }\n\n"
        "    template <typename TField>\n"
        "    void printFieldValue(const TField& field, OptionalFieldTag) const\n"
        "    {\n"
        "        if (field.isMissing()) {\n"
        "            std::cout << \"<missing>\";\n"
        "            return;\n"
        ...
        "    }\n\n"
        "    template <typename TField>\n"
        "    void printFieldValue(const TField& field, VariantFieldTag) const\n"
        "    {\n"
        ...
        "        field.currentFieldExec(VariantFieldPrinter(m_indent + 1));\n"
        "    }\n\n"
        "    template <typename T>\n"
        ...
        "        auto iter = begIter;\n\n"
        "        // Do the read\n"
        "        auto es = frame.read(msgPtr, iter, len - consumed);\n"
