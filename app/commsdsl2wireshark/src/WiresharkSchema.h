...
public:
    ...
    static WiresharkSchema& wiresharkCast(GenSchema& generator)
    {
        return static_cast<WiresharkSchema&>(generator);
    }

    static const WiresharkSchema& wiresharkCast(const GenSchema& generator)
    {
        return static_cast<const WiresharkSchema&>(generator);
    }
