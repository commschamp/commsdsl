...
def do_sub2_frame(payload):
    return payload

def pcap1(f):
    seq = 1000
    sub1_msg1_payload = struct.pack('>H', 1)
    sub1_msg1 = do_sub1_frame(1 + len(sub1_msg1_payload), 0, sub1_msg1_payload)
    sub2_msg2_payload = struct.pack('>H', 2)
    sub2_msg2 = do_sub2_frame(sub2_msg2_payload)
