...
def pcap1(f):
    seq = 1000
    msg1_payload = struct.pack('>BB3sHH', 6, 3, b"bla", 0, 0xffff)
...
def pcap2(f):
    seq = 2000
    msg2_payload = struct.pack('>BB3sHH', 6, 3, b"bla", 0, 0xffff)
...
def pcap3(f):
    # Malformed packet error is expected
    seq = 3000
    msg3_payload = struct.pack('>BB', 1, 0)
