...
public:
    ...
    static Ptr create(::xmlNodePtr node, ParseProtocolImpl& protocol);
    ...
    bool verifyAlias(const std::vector<Ptr>& aliases, const std::vector<ParseFieldImplPtr>& fields) const;
