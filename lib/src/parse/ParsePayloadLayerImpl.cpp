...
ParseLayerImpl::ParseKind ParsePayloadLayerImpl::parseKindImpl() const
{
    return ParseKind::Payload;
}

bool ParsePayloadLayerImpl::parseVerifyImpl(const ParseLayerImpl::ParseLayersList& layers)
{
