...
Field::Ptr Field::create(Generator& generator, commsdsl::parse::Field field, Elem* parent)
{
    using CreateFunc = FieldPtr (Generator::*)(commsdsl::parse::Field field, Elem* parent);
    ...
    return (generator.*func)(field, parent);
}
