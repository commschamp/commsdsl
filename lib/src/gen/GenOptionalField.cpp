...
public:
    ...
    {
        GenField::genSetFieldReferencedIfExists(m_externalField, referenced);
        GenField::genSetFieldReferencedIfExists(m_memberField.get(), referenced);
    }
...
void GenOptionalField::genSetReferencedImpl(bool referenced)
{
